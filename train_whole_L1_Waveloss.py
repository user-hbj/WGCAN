...
def train_and_evaluate(args, alpha, beta):
    ...
    # lr scheduler
    scheduler = optim.lr_scheduler.StepLR(G_opt, step_size=400, gamma=0.5)
    ...
    for epoch in range(lastepoch,args.num_epoch):
        ...
        for i, databatch in enumerate(train_loader):
            ...
            loss_wave = criterion_wave(outputs, gt_patch)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_dir', type=str, default='/raid/hbj/Wave_GCC/result_zpc/whole_pipline/new_dwt_RCABS/whole_stage_Sony/L1_WaveLoss_sum1_weights')
    ...
    # weight_candidates = [(0.1, 0.9), (0.2, 0.8), (0.3, 0.7), (0.4, 0.6), (0.5, 0.5), (0.6, 0.4), (0.7, 0.3), (0.8, 0.2), (0.9, 0.1)]
    
    # for alpha, beta in weight_candidates:
    #     print(f"Training with weights: alpha={alpha}, beta={beta}")
    #     train_and_evaluate(args, alpha, beta)

    train_and_evaluate(args, 0.8, 0.2)