...
from models.whole_new_dwt_RCABS_Two_Stages_LongRaw_NextModel_BaoHan import *
...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_dir', type=str, default='/raid/hbj/Wave_GCC/result/whole_pipline/new_dwt_RCABS/whole_stage/TwoStages_L1_FirstModel_NextSecond_NoDongjie_BaoHan')
